            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${listePropre}" var="act">
                    ...
                    <tr>
                        ...
                        <td><a href="ControleurFamille?action=periodes&nom=${nom}&prenom=${prenom}&idActivite=${act.getIdActivite()}&activite=${act.getNomActivite()}&prix=${act.getPrixParJour()}" class="btn btn-info">Selection de periode</a></td>
