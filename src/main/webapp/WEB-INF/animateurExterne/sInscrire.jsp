<%-- 
    Document   : recruterAnimateurExterieur
...
<html>
    <head>
        ...
        <title>S'inscrire comme animateur</title>
    ...
    <body>
        ...
        <div class="page-header">
            <h1 class="text-center">S'inscrire comme animateur externe</h1>
        </div>
        <div class="col-md-4 col-md-offset-4"> 
            <form method="POST" class="form-horizontal" action="ControleurExterne">
